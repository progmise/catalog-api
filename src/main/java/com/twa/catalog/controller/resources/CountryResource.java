...
public interface CountryResource {
    ...
    @Operation(
        description = "Get the information about one country",
        responses = {
            @ApiResponse(
                responseCode = "200",
                description = "Return the information of one country",
                content = @Content(
    ...
    @Operation(
        description = "Create one country",
        responses = {
            @ApiResponse(
                responseCode = "200",
                description = "Create one country",
        ...
        requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
            content = @Content(
                examples = @ExampleObject(
                    name = "Country",
                    summary = "Example country to create",
                    value = "{\"code\": \"Tes\", \"description\": \"Test\" }"
                )
            )
        )
    )
    ...
    @Operation(
        ...
        requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
            content = @Content(
                examples = @ExampleObject(
                    name = "Country",
                    summary = "Example country to update",
                    value = "{\"id\": 1, \"code\": \"Tes\", \"description\": \"Test\" }"
                )
            )
        )
    )
